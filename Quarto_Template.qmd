---
title: Template!
subtitle: And it looks pretty too...
format:
  clean-revealjs:
    chalkboard: true
    drop: 
      ...
      webr:
        packages:
          - tidyverse
    header-logo-left: img/bsa_logo_2.png
    header-logo-left-height: 1.8em
...
author:
  - name: Kevin Baer
    ...
    affiliations: Bruin Sports Analytics President
date: last-modified
...
- We'll use the same basic structure as the
...
- Use the `.bg` class for custom background, e.g. [important note]{.bg style="--col: #ff96a9"}.
...
::: {.column width="50%"}
![](img/kanagawa.jpg){.absolute width=727.806px height=450.47px left=3px top=145px}
:::

::: {.column width="50%"}
:::{.absolute width=378.669px height=471.732px left=707.593px top=167.765px style="font-size: 36px;"}
- A [point]{.bg-purple} about the [figure]{.text-yellow} that is potentially important.
- Another point about the figure that is also potentially important.
:::
:::

::::
:::{.absolute width=1072.98px height=112.691px left=8px top=585.309px}
...
![](img/kanagawa.jpg){.absolute width=1030.92px height=496.314px left=10.9034px top=136.162px}
...
- Thanks to [Grant McDermott](https://github.com/grantmcdermott/quarto-revealjs-clean){target="_blank"} for the slide theme. 

- Check out the GitHub repo to see all of the cool extensions used.
